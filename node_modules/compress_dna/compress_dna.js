...
* @returns {any}
*/
export function compress_dna(name, uuid, properties, zomes, wasms) {
    var ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(uuid, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    var ret = wasm.compress_dna(ptr0, len0, ptr1, len1, addHeapObject(properties), addHeapObject(zomes), addHeapObject(wasms));
