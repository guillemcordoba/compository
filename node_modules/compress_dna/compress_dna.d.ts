...
* @returns {any}
*/
export function compress_dna(name: string, uuid: string, properties: any, zomes: any, wasms: any): any;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
  readonly memory: WebAssembly.Memory;
  readonly compress_dna: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
